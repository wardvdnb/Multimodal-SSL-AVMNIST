...
from models.dino import MultiModalDINOSemiSupervisedLightning, SimpleMultiModalEncoder
...
def main():
    ...
    config_path = os.path.join(Path.cwd().parent, 'configs', 'config_semi_supervised.yaml')
    # ------------------------------------------------------------------------
    ...
    model = MultiModalDINOSemiSupervisedLightning(
