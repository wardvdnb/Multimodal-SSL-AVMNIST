...
# NOTE: this is a modified version of CentralNet code acquired from:
# https://github.com/jperezrua/mfas/blob/master/models/central/avmnist.py#L157
...
import models.centralnet.aux_models as aux
...
class SimpleAV_CentralNet(nn.Module):
    def __init__(self, args, audio_channels, image_channels):
        ...
        self.central_classifier = nn.Linear(args.channels*16, args.num_outputs) # MODIFIED from nodes -> args.channels*16
